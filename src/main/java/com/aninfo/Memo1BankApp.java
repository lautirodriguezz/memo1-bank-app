...
public class Memo1BankApp {
	...
	public Transaction createTransaction(@PathVariable Long cbu, @RequestParam Double sum, @RequestParam String typeTransaction) { 
		return transactionService.createTransaction(cbu, sum, typeTransaction); 
	}
